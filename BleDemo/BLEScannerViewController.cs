...
namespace BleDemo
{
    public partial class BLEScannerViewController : UIViewController, INavigation
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            uitableView.Source = new BleTableViewSource(deviceList, adapter, this);
        ...
        public void launchViewController(IDevice device)
        {
            BLEDetailViewViewController bleDetailView = new BLEDetailViewViewController();
            bleDetailView.device = device;
            this.NavigationController.PushViewController(bleDetailView, false);
        }
    }
}
